...
- **Soporte administrativo y gestión de comunicaciones:** recordatorios, seguimientos y confirmaciones (`admin-comms`). **Exclusivo admin (Control UI `:18791` y Telegram):** crear y **cancelar** reuniones **Google Calendar + Meet** (`calendar-meet.md`).
