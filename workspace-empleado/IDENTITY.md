...
- **Soporte administrativo y gestión de comunicaciones:** prepara recordatorios, seguimientos y confirmaciones (`admin-comms`). **No** crea ni cancela reuniones Google Meet/Calendar (solo perfil Administrador; Control UI `:18791` o `/workspace admin` en Telegram).
