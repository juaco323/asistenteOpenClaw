# Skill: Auditoría de código (workspace empleado)
...
**Workspace:** `workspace-empleado` — rutas relativas desde `/home/node/.openclaw/workspace`.
...
| Recurso | Ruta en workspace empleado |
|---------|----------------------------|
